...
public class OwnLinkedListNode {
    ...
    public OwnLinkedListNode getNext() {
        return nextNode;
    }

    public OwnLinkedListNode getPrevious() {
        return previousNode;
    }

    public void setNext(OwnLinkedListNode nextNode) {
        this.nextNode = nextNode;
    }

    public void setPrevious(OwnLinkedListNode previousNode) {
        this.previousNode = previousNode;
    }
}
